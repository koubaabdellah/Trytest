...
;(function ($, document, window, navigator, undefined) {
    ...
    var base_html =
      //  '<span class="irs-bar irs-play" > <i id="play2" class="fa fa-pause"> </i> </span> <span class="irs-bar irs-play" >  <i id="pause" class="fa fa-play"> </i> </span>'+ 
