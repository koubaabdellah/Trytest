...
function SluitHelp() {
	...
	/* mdb toegevoegd op 29-10-2010 */
	WisselVraagteken("");
	// VA terug naar helpbutton focus
	//eerste stuk van id weghalen: divHelpVraag1 -> Vraag1
	closeID = prevFocus.slice(7);
	
	//zoek id op in html
	var vraagID = document.getElementById('div'+closeID);
	//zet focus op <a> cl.btnInfo
...
/**
 * Haal alle helpbuttons in de IAH binnen
 * Voor elke button in array,  vraag de onclick attribuut op
 * Verwijder alle attributen en maak vervolgens een nieuw element <a> aan
 * Het <a> element wordt om de image heen geplaatst, zodat de helpbuttons klikbaar zijn
 */
document.addEventListener("DOMContentLoaded", 	function() {
	...
	for (i=0; i < helpboxen.length; i++) {
		...
		// place the <a> and wrap it around the image
