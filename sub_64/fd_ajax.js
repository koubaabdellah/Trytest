...
var FDAjaxDataForm = new Class({
	...
	createDefaultUrl: function (action) {
		...
		return FDUri.base('account' + (FD.isBackend() || typeof(WYSIWYG) != 'undefined' || FDUri.current.queryExists('r') ? '.admin' : '')).addPath('data/' + action[1] + '/' + formid + '/'); // new FDUri(prefix + 'data/' + action[1] + '/' + formid + '/');
	},
