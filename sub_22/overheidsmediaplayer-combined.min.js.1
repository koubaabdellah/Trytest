...
(function($) {
    ...
    MediaElementPlayer.prototype.buildaudiodescription = function(player, controls, layers, media) {
        ...
        var adPlayer = null;
        var isActive = false;
        $adBtn = $('<div class="mejs__button mejs__audiodescription-button mejs__audiodescription-inactive"><button></button></div>');
...
$.fn.createCollapsePanels = function () {
    ...
    return this.each(function (iteration) {
        ...
        function initButtons() {
            $cp.find('button').on("click", function () {
        ...
        function openPanel($panel) {
            ...
            $panel.addClass('open');
            var $panelContent = $panel.find('.panelContent');
            $panelContent.attr('aria-expanded', 'true');
            $panelContent.attr('aria-hidden', 'false');
            $panelContent.focus();
        }
...
$('.block-audio-video').createCollapsePanels();
