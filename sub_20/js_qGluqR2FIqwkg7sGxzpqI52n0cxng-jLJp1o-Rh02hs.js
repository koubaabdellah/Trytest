...
(function ($, Drupal, drupalSettings) {
  'use strict';
  Drupal.behaviors.gravotech_dealer_locator  = {
    attach: function (context, settings) {
      let label = $('.dealer-locator-filter label', context);
      let selects = $('.dealer-locator-filter .form-select', context);

      $(selects, context).each(function(index) {
        $(this).select2({
          placeholder: label[index].innerHTML,
          width: 'resolve',
          closeOnSelect: false
        });
      });
