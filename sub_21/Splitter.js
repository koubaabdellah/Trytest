define(["require", "exports"], function (require, exports) {
    ...
    var Split = function (ids, options) {
        ...
        var sizes = getOption(options, 'sizes', null) || ids.map(function () { return 100 / ids.length; });
        ...
        function keyboardNav(key) {
            ...
            if (this.direction === "vertical") {
                ...
                if (key.code === "ArrowRight") {
                    this.dragging = true;
                    drag.call(this, { clientAxis: Math.abs(rect.right) });
                }
                else if (key.code === "ArrowLeft") {
                    this.dragging = true;
                    drag.call(this, { clientAxis: rect.left });
                }
                else {
                    this.dragging = false;
                }
