...
define(["dojo/_base/declare",
  ...
  function(declare, lang, array, on, domClass, _WidgetBase, _TemplatedMixin,
    _WidgetsInTemplateMixin, template, i18n, SearchBox, BBoxOption, ScopeOptions, TypeOptions, SortOptions, ResultsPane, Paging, ResultCount, dom) {
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        this.scopeOptions = new ScopeOptions({
          wabWidget: this
        },dom.byId("scopeOptions"));
        
        this.searchBox = new SearchBox({
          wabWidget: this
        },dom.byId("searchBox"));
        this.bboxOption = new BBoxOption({
          wabWidget: this
        },dom.byId("bboxOption"));

        this.typeOptions = new TypeOptions({
          wabWidget: this
        },dom.byId("typeOptions"));

        this.sortOptions = new SortOptions({
          wabWidget: this
        },dom.byId("sortOptions"));

        this.resultsPane = new ResultsPane({
          wabWidget: this
        },dom.byId("resultsPane"));

        this.paging = new Paging({
          wabWidget: this
        },dom.byId("paging"));

        this.resultCount = new ResultCount({
          wabWidget: this
        },dom.byId("resultCount"));
