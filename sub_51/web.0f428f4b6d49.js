...
<head>
    ...
    <meta charset="utf-8">
    <title>Adviescommissie Duurzaamheid Biomassa voor Energietoepassingen</title>
    ...
    <meta name="msapplication-TileColor" content="#da532c">
        ...
        <meta name="theme-color" content="#4e9625">
    
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="version" content="1.0.0">
    <meta name="relative-path" content="">
    <meta name="description" content="De Adviescommissie Duurzaamheid Biomassa voor Energietoepassingen (ADBE) is een door de overheid ingestelde commissie. De commissie adviseert de minister van Economische Zaken en Klimaat over de mate waarin certificatieschema&#x27;s de duurzaamheid van vaste biomassa voor energietoepassingen waarborgen.">
    <meta name="og:title" content="Adviescommissie Duurzaamheid Biomassa voor Energietoepassingen">
    <meta name="og:description" content="De Adviescommissie Duurzaamheid Biomassa voor Energietoepassingen (ADBE) is een door de overheid ingestelde commissie. De commissie adviseert de minister van Economische Zaken en Klimaat over de mate waarin certificatieschema&#x27;s de duurzaamheid van vaste biomassa voor energietoepassingen waarborgen.">
    

    
    <link href="/static/frontend/web.b7f64a687c7d.css" rel="stylesheet" type="text/css" media="screen">
        ...
        <link href="/custom.css?v=" rel="stylesheet" type="text/css" media="screen">
...
<body class="___leraar">
    ...
    <script nonce="44RKrmvB871if/sAJ5BdMA==">window.__SETTINGS__ = {"site": {"language": "nl", "name": "Adviescommissie Duurzaamheid Biomassa voor Energietoepassingen", "theme": "leraar", "startPage": "cms", "startPageCms": "8e4dd078-6af4-4c36-a35b-7860847d2439", "accessIds": [{"id": 0, "description": "Alleen eigenaar"}, {"id": 1, "description": "Ingelogde gebruikers"}, {"id": 2, "description": "Iedereen (publiek zichtbaar)"}], "defaultAccessId": 2, "likeIcon": "thumbs", "limitedGroupAdd": true, "cookieConsent": false, "isClosed": false, "newsletter": true}, "backendVersion": "2.0", "env": "prod", "odtEnabled": false, "enableSharing": false, "showUpDownVoting": false, "externalLogin": true, "groupMemberExport": false, "showExcerptInNewsCard": false, "numberOfFeaturedItems": "0", "enableFeedSorting": true, "commentsOnNews": false, "eventExport": true, "eventTiles": false, "subgroups": false, "statusUpdateGroups": false, "showExtraHomepageFilters": false, "showViewsCount": false, "showLoginRegister": false, "kalturaVideoEnabled": false, "kalturaVideoPartnerId": "", "kalturaVideoPlayerId": "", "showSuggestedItems": false, "pdfCheckerEnabled": true, "maxCharactersInAbstract": 320, "collabEditingEnabled": false, "preserveFileExif": false};</script>
    

    

    <script nonce="44RKrmvB871if/sAJ5BdMA==">__webpack_nonce__ = '44RKrmvB871if/sAJ5BdMA==';</script>

    
    <script src="/static/frontend/vendor.8f086f856651.js" nonce="44RKrmvB871if/sAJ5BdMA=="></script>
    <script src="/static/frontend/web.e3c484baab93.js" nonce="44RKrmvB871if/sAJ5BdMA=="></script>
    

    
    <script nonce="44RKrmvB871if/sAJ5BdMA==">
        document.querySelector('body').dataset['matomo'] = '1047';
var _mtm = window._mtm = window._mtm || [];
_mtm.push({'mtm.startTime': (new Date().getTime()), 'event': 'mtm.Start'});
var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];
g.async=true; g.src='https://stats.pleio.nl/js/container_G6lHn5E5.js'; s.parentNode.insertBefore(g,s);
    </script>
    ...
    <!-- Piwik -->
    <script type="text/javascript" nonce="44RKrmvB871if/sAJ5BdMA==">
    var _paq = _paq || [];
    _paq.push(['trackPageView']);
    _paq.push(['enableLinkTracking']);
    (function() {
        var u="https://statistiek.rijksoverheid.nl/piwik/";
    ...
    <noscript><p><img src="https://statistiek.rijksoverheid.nl/piwik/piwik.php?idsite=1047" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik -->
