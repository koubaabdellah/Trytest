...
<head>
    ...
    <meta name="description" content="Het boa-expertisecentrum is een centrale plek waar kennis, expertise, trends en ontwikkelingen rondom de boa samenkomen.">
    <meta name="og:title" content="boa-expertisecentrum">
    <meta name="og:description" content="Het boa-expertisecentrum is een centrale plek waar kennis, expertise, trends en ontwikkelingen rondom de boa samenkomen.">
...
<body class="___rijkshuisstijl">
    ...
    <script nonce="pqTrYzu+Arbrv/3ZX4FVGQ==">window.__SETTINGS__ = {"site": {"language": "nl", "name": "boa-expertisecentrum", "theme": "rijkshuisstijl", "startPage": "cms", "startPageCms": "e7546c87-38dd-4665-8888-f222f6aa83f7", "accessIds": [{"id": 0, "description": "Alleen eigenaar"}, {"id": 1, "description": "Ingelogde gebruikers"}, {"id": 2, "description": "Iedereen (publiek zichtbaar)"}], "defaultAccessId": 2, "likeIcon": "thumbs", "limitedGroupAdd": false, "cookieConsent": true, "isClosed": false, "newsletter": false}, "backendVersion": "2.0", "env": "prod", "odtEnabled": false, "enableSharing": true, "showUpDownVoting": true, "externalLogin": true, "groupMemberExport": false, "showExcerptInNewsCard": false, "numberOfFeaturedItems": "6", "enableFeedSorting": true, "commentsOnNews": true, "eventExport": false, "eventTiles": false, "subgroups": false, "statusUpdateGroups": true, "showExtraHomepageFilters": false, "showViewsCount": false, "showLoginRegister": true, "kalturaVideoEnabled": false, "kalturaVideoPartnerId": "", "kalturaVideoPlayerId": "", "showSuggestedItems": false, "pdfCheckerEnabled": true, "maxCharactersInAbstract": 320, "collabEditingEnabled": false, "preserveFileExif": false};</script>
    

    

    <script nonce="pqTrYzu+Arbrv/3ZX4FVGQ==">__webpack_nonce__ = 'pqTrYzu+Arbrv/3ZX4FVGQ==';</script>

    
    <script src="/static/frontend/vendor.8f086f856651.js" nonce="pqTrYzu+Arbrv/3ZX4FVGQ=="></script>
    <script src="/static/frontend/web.e3c484baab93.js" nonce="pqTrYzu+Arbrv/3ZX4FVGQ=="></script>
    

    
    <script nonce="pqTrYzu+Arbrv/3ZX4FVGQ==">
...
g.async=true; g.src='https://stats.pleio.nl/js/container_G6lHn5E5.js'; s.parentNode.insertBefore(g,s);
    ...
    ga('create', 'http://boa-expertisecentrum.nl', 'auto');
    ga('send', 'pageview');
    </script>
    ...
    <!-- Piwik -->
    <script type="text/javascript" nonce="pqTrYzu+Arbrv/3ZX4FVGQ==">
    var _paq = _paq || [];
    ...
    <noscript><p><img src="https://stats.pleio.nl/piwik.php?idsite=8101" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik -->
