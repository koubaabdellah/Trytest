...
/**
 * @file
 * AERIUS target _blank script.
 */

(function($) {

    // Jump to the current event.
    Drupal.behaviors.linkAboutBlank = {
        attach: function(context) {

            $('a').each(function() {
                var value = $(this).attr('href');
                var manuals = new RegExp('^.*?/nl/manuals/.*$');
                var handleiding = new RegExp('^.*?/nl/handleiding/.*$');
                if (!manuals.test(value) && !handleiding.test(value)) {
