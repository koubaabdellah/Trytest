<!DOCTYPE html><html lang="en" class="notranslate" translate="no"><!-- All translators --><head>
  <meta charset="utf-8">
  <title>Wolf</title>
  <base href="/">
  ...
  <!-- Added to allow web app tp run in fullscreenmode on iOS when saved to homescreen -->
  <meta name="apple-mobile-web-app-capable" content="yes">

  <!-- Added for favicon support on all devices and browsers -->
