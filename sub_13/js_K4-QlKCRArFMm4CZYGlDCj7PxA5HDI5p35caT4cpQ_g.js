...
!function(){"use strict";!function(i,e){e.behaviors.reachClientSideValidation={attach:function(){i.validator.setDefaults({errorElement:"span",errorPlacement:function(i,e){i.addClass("invalid-feedback"),e.closest(".col-form-element").append(i)},highlight:function(e,n,a){i(e).addClass("is-invalid")},unhighlight:function(e,n,a){i(e).removeClass("is-invalid")},ignore:":hidden, .ignore"})}}}(jQuery,Drupal)}();;
/**
 * @file
