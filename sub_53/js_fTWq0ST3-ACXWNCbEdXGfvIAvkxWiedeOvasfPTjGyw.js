/* Source and licensing information for the line(s) below can be found at https://www.cjib.nl/libraries/jquery-validation/dist/jquery.validate.js. */
/*!
...
/* Source and licensing information for the above line(s) can be found at https://www.cjib.nl/libraries/jquery-validation/dist/jquery.validate.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.cjib.nl/modules/contrib/clientside_validation/clientside_validation_jquery/js/cv.jquery.validate.js. */
/**
 * @file
...
/* Source and licensing information for the above line(s) can be found at https://www.cjib.nl/modules/contrib/clientside_validation/clientside_validation_jquery/js/cv.jquery.validate.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.cjib.nl/core/misc/debounce.js. */
/**
...
/* Source and licensing information for the above line(s) can be found at https://www.cjib.nl/core/misc/debounce.js. */;
/* Source and licensing information for the line(s) below can be found at https://www.cjib.nl/modules/contrib/clientside_validation/clientside_validation_jquery/js/cv.jquery.ckeditor.js. */
/**
 * @file
 * Attaches behaviors for the Clientside Validation jQuery module.
 */
...
/* Source and licensing information for the above line(s) can be found at https://www.cjib.nl/modules/contrib/clientside_validation/clientside_validation_jquery/js/cv.jquery.ckeditor.js. */;
...
/**
 * CJIB Feedback positive feedback handler.
 */
; (function (Drupal) {
  'use strict';

  Drupal.behaviors.cjib_feedback_positive_feedback_handler = {
    attach: (context, settings) => {
      const handler = context.querySelector('#' + settings.cjib_feedback.positiveFeedbackElement)
      if (handler) {
