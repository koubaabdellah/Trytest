...
ath.intl = {
	...
	nl_nl: {
		ios: 'Om een snelkoppeling naar deze website te installeren, klik op %icon en dan <strong>Zet in beginscherm</strong>.',
		android: 'Om een snelkoppeling naar deze website te installeren, open het browser-opties scherm en druk op <strong>Toevoegen aan startscherm</strong>. <small>Het menu kan worden benaderd door op de menu knop te drukken <span class="ath-action-icon">icon</span>.</small>',
	},
...
ath.Class = function (options) {
	...
	if ( this.options.debug && (typeof options.logging === "undefined") ) {
