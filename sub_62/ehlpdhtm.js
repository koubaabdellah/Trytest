...
function TextPopup( el )
{
	...
	if( srcDiv )
	{
		/* Begin Belastingdienst modify drop down behaviour */
				
		var parent = el.parentNode;
			parent.classList.toggle("with-open-dropdown");
			
			var openText = " (ingeklapt)";
			var closeText = " (uitgeklapt)";
			
			var accessibleText = el.getElementsByClassName('accessibility-text')[0];
			
			if(parent.classList.contains("with-open-dropdown")) {
				
				accessibleText.innerHTML = closeText;
				
				var close = document.createElement("span");
					close.setAttribute("class", "close-dropdown");
					close.innerHTML = "sluiten";
					
				el.appendChild(close);	
				
			} else {
				var closeElement = el.getElementsByClassName("close-dropdown");
				
				accessibleText.innerHTML = openText;
				
				for(var i=0; i<closeElement.length;i++) {
					el.removeChild(closeElement[i]);
				}
			}

		/* End Belastingdienst modify drop down */
